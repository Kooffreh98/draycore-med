  ...
  return (
    <div className="flex bg-gray-100 min-h-screen">
      ...
      <div className="flex-1 p-6 space-y-6 pt-20 bg-gray-100">
        {/* Dashboard Header */}
        <div className="bg-white p-6 rounded-lg shadow-md dash">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md flex flex-col h-full dash">
          <div className="flex justify-between items-center border-b border-gray-200 pb-4">
            <h3 className="text-md sm:text-md md:text-lg lg:text-lg font-semibold text-gray-800">
              Recent Searches
            </h3>
